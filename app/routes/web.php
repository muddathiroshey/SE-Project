...
$router->get('/admin/kyc/detail',          [AdminController::class, 'kycDetail']);
$router->post('/admin/kyc/decide',         [AdminController::class, 'kycDecide']);
$router->get('/admin/disputes',            [AdminController::class, 'disputes']);
$router->get('/admin/sanctions',           [AdminController::class, 'sanctions']);
$router->post('/admin/sanctions/create',   [AdminController::class, 'sanctionCreate']);
$router->post('/admin/sanctions/withdraw', [AdminController::class, 'sanctionWithdraw']);
