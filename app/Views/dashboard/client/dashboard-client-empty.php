      ...
      <div class="dropdown">
        ...
        <div class="dropdown-menu hidden" id="user-dd">
          ...
          <form method="POST" action="/logout" style="margin:0;">
            <button type="submit" class="dropdown-item" style="color:var(--rust);width:100%;text-align:left;background:none;border:none;cursor:pointer;">Sign Out</button>
          </form>
        </div>
      </div>
    </div>
  ...
  <div class="content-area">
    ...
    <div style="margin-bottom:40px;">
      ...
      <p style="font-size:1rem;color:var(--ink-mid);margin:0;">
        You have <strong>0 active projects</strong> and <strong>0 pending bids</strong>.
      </p>
    </div>
