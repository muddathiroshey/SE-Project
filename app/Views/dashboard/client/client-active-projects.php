...
<div class="main-layout">
  ...
  <aside class="sidebar">
    ...
    <div class="sidebar-section">
      ...
      <a class="sidebar-link active" href="/my-projects/active">
    ...
    <div class="sidebar-section">
      ...
      <a class="sidebar-link" href="/incoming-bids">
  ...
  <div class="content-area">
    ...
    <div class="page-header flex justify-between items-center">
      ...
      <a href="/post-job" class="btn btn-primary">+ Post New Project</a>
    </div>
    ...
    <a href="/project-detail" class="proj-card status-active" style="text-decoration:none;display:block;" id="pc-0">
    ...
    <a href="/project-detail" class="proj-card status-pending-review" style="text-decoration:none;display:block;" id="pc-1">
      <div class="proj-card-body">
    ...
    <a href="/project-detail" class="proj-card status-dispute" style="text-decoration:none;display:block;" id="pc-2">
      <div class="proj-card-body">
    ...
    <div class="empty-state hidden" id="empty-state">
      ...
      <p class="text-sm text-muted">Try clearing your filter or <a href="/post-job" style="color:var(--gold);">post a new project</a>.</p>
    </div>
